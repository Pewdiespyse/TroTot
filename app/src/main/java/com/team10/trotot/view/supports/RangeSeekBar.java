...
public class RangeSeekBar<T extends Number> extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.ic_notification_setting_seek_thumb_normal;
        int thumbPressed = R.drawable.ic_notification_setting_seek_thumb_pressed;
        int thumbDisabled = R.drawable.ic_notification_setting_seek_thumb_disabled;
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (showLabels) {
            ...
            String minLabel = getContext().getString(R.string.notification_setting_demo_min_label);
            String maxLabel = getContext().getString(R.string.notification_setting_demo_max_label);
